  ...
  it(
    ...
    async () => {
      ...
      try {
        ...
        expect(deepContainsValue(entry, "2.1.216"), "the drift entry must name the tested range's maximum").toBe(true);
