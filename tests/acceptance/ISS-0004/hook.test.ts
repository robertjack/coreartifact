...
// never imported directly — see the contract's "self-contained,
// zero-dependency, imports nothing but node: builtins" requirement — it is
// only ever invoked as a subprocess.
//
...
import { existsSync, mkdirSync, copyFileSync, chmodSync, mkdtempSync, rmSync } from "node:fs";
