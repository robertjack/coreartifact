...
- [Hermetic fixture replay](feedback_hermetic_fixture_replay.md) — pin cwd + transcript_path on every replayed line (machine leftovers live at recorded absolute paths, ×3 in PRD-0003); assert ABSENT values, not only reason rows.
